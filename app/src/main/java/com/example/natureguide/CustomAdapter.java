...
public class CustomAdapter extends BaseAdapter {
    ...
    private NatureLocation[] locationArr;
    private static LayoutInflater inflater;  //for inflate layout items
    private GoogleMap mMap;
    //data base ref
    private FirebaseDatabase database;
    private DatabaseReference favLocationRef, userRef, locationsRef;
    //firebase auth user
    ...
    private ImageView img_like, img_whatsapp;
